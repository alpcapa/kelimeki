...
| **24.5** Mağaza vitrini | ✅ cevap kâğıdı · metinler (ölçülü) · App Privacy eşlemesi · yaş derecesi · demo hesap `T2` · ⚙️ **ekran görüntüleri: boru hattı KURULDU** (9 Eyl — `integration_test/` + `test_driver/` + `ios-screenshots.yml`, iPhone 6.9" + iPad 13"), ⚠ **HİÇ KOŞMADI**; bugün 1/6 kare |

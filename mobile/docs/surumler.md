...
| **1.1.0** | **654** (iOS) | `c22b757` | 11 Eyl 2026 (`c22b757`, #527) | **11 Eyl 2026, 16:08** (App Store incelemesine GÖNDERİLDİ) | ⏳ **App Store incelemesinde** — mağazaya gönderilen İLK paket | İki Canlı oyun düzeltmesi (sahte "Sıra sende değil." + sonsuz "Yükleniyor…") + mağaza kareleri. ⚠ Play tarafı hâlâ **627**'de: `.aab` (654) `mobile-latest`'te hazır ama Play'e YÜKLENMEDİ. Aşağı bkz. |

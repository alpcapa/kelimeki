...
| **1.1.0** | **665** (iOS ✅ + Play ⏳) | `9c62289` | 12 Eyl 2026 (PR #533 merge'i) | ✅ ASC: **665 iliştirildi + sürüm İNCELEMEDE** (12 Eyl 17:32, `Waiting for Review`, elle yayın) · ⏳ Play: 13 Eyl'de yüklenecek | ⏳ **senkron penceresi AÇIK** (ASC 665 ↔ Play 659) | PR #533'ün merge'inin YAN ÜRÜNÜ (koşu #665). 659'dan farkı üç iş: mesaj satırı kırpması · ipucu tavanı 2→1 · oyun sonu kutlaması. Aşağı bkz. |

...
test('Zorluk: Zor seçilip oyun başlar, YZ geniş aramayla hamle yapar, seviye kayda yazılır', async ({
  ...
  await expect(page.getByText('Çok iyi oyuncuyum, genelde %80+ kazanırım diyorsanız bunu denemelisiniz. Bu seviyede birincilik 4 puan kazandırıyor. Bol şans!')).toBeVisible();

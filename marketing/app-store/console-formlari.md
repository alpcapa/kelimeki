...
| **1.1.1 gönderimi** | ✅ **YAYINDA** (26 Eyl 2026, elle `Release This Version`, Play'le aynı gün) — onay 25 Eyl 22:49, gönderim 25 Eyl 13:21 | `+ Version` → 1.1.1 · build **723** · What's New girildi · Notes 1.1.0'dan AYNEN (§16 kalıcı cevabı) · Manually release. Submission ID `6df19844-c038-4e76-af43-6fb1f9274a30`. Kayıt: `mobile/docs/surumler.md` → "1.1.1" |

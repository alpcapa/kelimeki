...
| **Yayın** | ⏳ **BAŞLATILDI** (15 Eyl, 06:02) | Kullanıcı `Release This Version`a bastı. Kapı önce ölçüldü: Free Apps Agreement **`Active`** (8 Eyl 2026 – 8 Eyl 2027) · DSA **`Active`** · Paid Apps `New` (ücretsiz uygulamada gerekmiyor) — onay e-postasındaki *"contracts not yet in effect"* uyarısı bu hesapta geçersiz. ⚠ **"YAYINDA" DEĞİL:** Apple "up to 24 hours" diyor ve vitrin ÖLÇÜLMEDİ; `itunes.apple.com` ajan ortamından ENGELLİ (proxy 403), doğrulamayı kullanıcı ya da başka bir ortam yapmalı. §26 Apple yarısının tetikleyicisi bu ölçüm |

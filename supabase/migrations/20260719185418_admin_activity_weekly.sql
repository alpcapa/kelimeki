-- Harfik — admin paneli büyüme grafiğine haftalık filtre desteği
--
-- admin_activity_series(p_periods, p_granularity) yalnızca 'day' ve 'month'
-- destekliyordu; admin panelinde artık "Haftalık" da seçilebildiğinden
-- p_granularity = 'week' eklendi — date_trunc('week', ...) ISO haftası
-- (Pazartesi başlangıçlı) kullanır.

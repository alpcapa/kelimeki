-- Harfik — büyüme grafiğine haftalık granülerlik desteği
--
-- admin_activity_series(p_periods, p_granularity) o ana kadar yalnızca
-- 'day'/'month' kabul ediyordu; 'week' seçeneği eklendi (date_trunc ile
-- haftalık kovalama).

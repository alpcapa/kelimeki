-- Harfik — 2 kişilik oyunda 2. olmak zaten oyunu kaybetmek demektir (tek
-- rakip var), dolayısıyla ona +1 lig puanı vermek anlamsızdı: puan
-- biriktirmek isteyen herkes hep 2 kişilik oynayabilirdi. Artık 2 kişilik
-- oyunlarda sadece 1. olan (rank=1) +2 puan alır, 2. olan (rank=2) 0 puan
-- alır. 4 kişilik oyunlarda kural değişmedi: 1.=+2, 2.=+1, 3./4.=0.
-- Tam beraberlik hâlâ aynı sırayı paylaşan herkese o sıranın puanını verir
-- (2 kişilik tam beraberlikte ikisi de rank=1 olur, ikisi de +2 alır).
--

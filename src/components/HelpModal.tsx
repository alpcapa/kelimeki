      ...
      <div className="flex flex-col gap-5">
        ...
        <Section title="Bonus Bölgesi">
          <div className="flex flex-col gap-1.5 mt-0.5">
            ...
            <Pill label="K3" color="#FBBF24" desc="Tam merkezdeki tek kare: kelime puanı üçe katlanır" />
          </div>
          <P>
            ...
            kelimeye uygulanır. Tam merkezdeki tek kare ayrıca K3'tür (üç kat kelime), ama bu
            yalnızca o kareye o tur yeni bir taş konursa uygulanır.
          </P>
        </Section>

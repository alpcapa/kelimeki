      ...
      <div className="flex flex-col gap-5">
        ...
        <Section title="Köşe Bölgeleri">
          ...
          <P>
            ...
            giren bir hamleden kazanılan puanın yarısı o köşenin sahibine aktarılır. Bir hamle
            aynı anda iki farklı rakibin köşesine giriyorsa puan üç kişi arasında (saldırgan ve
            iki köşe sahibi) eşit paylaşılır.
          </P>
        </Section>

    ...
    return (
      <>
        <button
          ...
          className="font-mono text-[9px] uppercase tracking-[1px] px-3 py-1 rounded-md border bg-accent border-accent text-white font-bold leading-none active:scale-[0.97] transition-transform"
        >
          Giriş
        </button>

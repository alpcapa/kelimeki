      ...
      <div className="grid grid-cols-6 gap-1.5">
        {LETTERS.map((letter) => (
          <button
            ...
            className="flex items-center justify-center h-11 rounded-md border border-tile-border bg-tile-bg font-mono font-bold text-[18px] text-tile-letter active:scale-90 transition-transform"
          >
            {letter}
          </button>
        ))}

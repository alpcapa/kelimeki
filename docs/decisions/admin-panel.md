...
- **Sekmeler (`AdminDashboard.tsx`):**
  - **Üyeler** — kendi bölümünde, aşağıda: "Sekme: Üyeler".
...
## Büyüme — Beğeni/Paylaşma · Arkadaşlık · `?` popup'ı
...
## Kaynak Hunisi — misafir hunisi (kaynak → gelen → üye → başlayan → biten)
...
## "Cihaz" tablosu — `device_visits` herkesi sayıyor

...
## Seviyeli YZ — motor sözleşmesinin tam dökümü (CLAUDE.md'den taşındı)

⚠ **Bu bölüm 15 Eylül 2026'da kök `CLAUDE.md`'den BİREBİR taşındı**
(Oyun Mekaniği Özeti → "YZ seviyesi" maddesi). Tek satırı değiştirilmedi; `CLAUDE.md`'de yerine kural
